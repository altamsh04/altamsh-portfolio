  ...
  return (
    <section className="w-full min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-slate-900 to-slate-950 text-white px-6 relative overflow-hidden">
      ...
      <div className="z-10 flex flex-col items-center justify-center max-w-4xl w-full mx-auto">
        ...
        {/* Name */}
        <h1
          className={`text-3xl md:text-5xl font-bold mb-3 text-center transition-all duration-700 delay-100 ${
        ...
        {/* Legend/Tagline */}
        <p
          className={`text-lg md:text-xl text-blue-200/80 mb-10 text-center font-light transition-all duration-700 delay-200 ${
            isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}
        >
        ...
        >
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white text-base font-medium px-8 py-3 rounded-md shadow-md hover:shadow-xl transition-all duration-300 flex items-center gap-2 cursor-pointer"
          >
        ...
        <div
          className={`flex gap-8 mt-12 transition-all duration-700 delay-400 ${
            isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}
        >
          <a
          ...
          >
            <div className="w-8 h-8 rounded-full bg-blue-600/20 flex items-center justify-center group-hover:bg-blue-600/30 transition-all duration-300 animate-bounce">
              <svg
                ...
                className="transform transition-transform duration-300 group-hover:translate-y-1 cursor-pointer"
                onClick={() => {
